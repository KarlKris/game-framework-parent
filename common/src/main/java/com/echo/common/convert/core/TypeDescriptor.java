...
public class TypeDescriptor implements Serializable {
    ...
    public boolean hasAnnotation(Class<? extends Annotation> annotationType) {
        ...
        return AnnotationUtil.hasAnnotation(this.annotatedElement, annotationType);
    }
    ...
    public <T extends Annotation> T getAnnotation(Class<T> annotationType) {
        ...
        return AnnotationUtil.getAnnotation(this.annotatedElement, annotationType);
    }
    ...
    public boolean isEqual(Class<?> clazz) {
        return clazz.equals(getType());
    }

    public boolean isStreamable() {
        return Streamable.class.isAssignableFrom(getType());
    }

    /**
     * Is This type a {@link Enum}?
     * @return
     */
    ...
    public boolean isCollectionLike() {
        return isCollection() || isArray() || isStreamable() || isEqual(Iterable.class);
    }
    ...
    public boolean isAssignableFrom(TypeDescriptor descriptor) {
        return getType().isAssignableFrom(descriptor.getType());
    }
     ...
     * {@link AnnotatedElement}, in particular to {@link AnnotationUtil}.
     *
     * @see AnnotationUtil#hasAnnotation(AnnotatedElement, Class)
     * @see AnnotationUtil#getAnnotation(AnnotatedElement, Class)
     */
